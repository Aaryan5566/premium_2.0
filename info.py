...
BOT_TOKEN = environ.get('BOT_TOKEN', "7945987697:AAGJHOURB4aNcJVTxdeK2dmohWsMRPlOWfs")
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002305897172'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002305897172').split()]
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002305897172'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Patrick_Botz')  # How to open tutorial link for verification
